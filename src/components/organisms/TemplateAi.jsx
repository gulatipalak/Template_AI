const TemplateAi = ({className=""}) => {
  return (
    <div className={`relative border border-light-white-1d dark:border-[#FFFFFF30] dark:bg-template-radial-dark bg-template-radial-light rounded-3xl transition duration-300 p-8 text-center center-inner-curve ${className}`}>
