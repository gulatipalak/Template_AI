const CardWapper = ({ children, className = '' }) => {
  return (
    <div className={`relative dark:bg-custom-gradient bg-light-custom-gradient border dark:border-white-1d border-light-white-1d rounded-3xl transition duration-300 ${className} overflow-hidden`}>
